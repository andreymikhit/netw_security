...
### 42. Каким образом можно декодировать текст, преобразованный на основе той или иной кодировки:
...
### 43. Злоумышленник создает файл, который будет содержать необходимый payload, с помощью команды msfvenom -р
...
### 44. Как злоумышленник может использовать слабости более старых поколений сетей 2G, 3G, при условии что сейчас повсеместно используется 4G?
