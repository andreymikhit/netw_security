...
~~описание последствий от резлизации уязвимости злоумьшленником: «Успешная эксплуатация позволяет удаленным или локальным ~~злоумышленникам выполнять команды через Shell, производить повышение привилегий или удаленное выполнение команд в зависимости от вектора атаки»;
